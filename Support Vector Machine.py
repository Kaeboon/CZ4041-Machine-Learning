...
Original file is located at
    https://colab.research.google.com/drive/1z28AyLYvuU5Rp0-7R83hNsKJ0wvVdHNz
...
for batch in tqdm(chunker(submission.img_pair.values)):
    ...
    pred = svc.predict(x_test).ravel().tolist()
    predictions += pred

submission['is_related'] = predictions

submission.to_csv("/content/drive/MyDrive/Projects file sharing/CZ4041_Project_KaeBoon/SVM.csv", index=False)
